<%@ Page Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="UnpaidBillReportUI.aspx.cs" Inherits="DiagnosticCenterBillManagementSystem.UI.UnpaidBillReportUI" %>
    ...
    <div class="mainBody">
        ...
        <div class=" content_table ">
            <div class="content-info">
                ...
                <asp:GridView ID="unpaidBillReportGridView" BorderStyle="None" BorderWidth="1px" CellPadding="3" CssClass="grid" HorizontalAlign="Center" EmptyDataText="No data available." BackColor="White" BorderColor="#CC9966" runat="server" ShowFooter="True" AutoGenerateColumns="False" OnRowDataBound="unpaidBillReportGridView_RowDataBound">
                    <Columns>
